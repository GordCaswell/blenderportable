...
${SegmentInit}
    ${If} $Bits = 64
		...
		Rename "$EXEDIR\App\Blender\2.77\datafiles" "$EXEDIR\App\Blender64\2.77\datafiles"
    ${Else}
        ${SetEnvironmentVariablesPath} FullAppDir $EXEDIR\App\Blender
		Rename "$EXEDIR\App\Blender64\2.77\datafiles" "$EXEDIR\App\Blender\2.77\datafiles"
    ${EndIf}
!macroend
